...
import { Grid, List, Heart, Star, Gem } from "lucide-react";
...
const Accessories = () => {
  ...
  const allProducts = useMemo(() => getProductsByCategory('Accessories'), []);
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-muted-foreground">
                Showing {currentProducts.length} of {sortedProducts.length} accessory products
              </p>
            ...
            <div className={`grid gap-6 ${
              ...
              {currentProducts.map((product) => (
                <Link key={product.id} to={`/categories/accessories/${product.id}`} className="group">
