...
import { Grid, List, Heart, Star, Headphones } from "lucide-react";
...
const Audio = () => {
  ...
  const allProducts = useMemo(() => getProductsByCategory('Audio'), []);
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-muted-foreground">
                Showing {currentProducts.length} of {sortedProducts.length} audio products
              </p>
