...
import { Grid, List, Heart, Star, Laptop } from "lucide-react";
...
const Computers = () => {
  ...
  const allProducts = useMemo(() => getProductsByCategory('Computers'), []);
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-muted-foreground">
                Showing {currentProducts.length} of {sortedProducts.length} computer products
              </p>
            ...
            <div className={`grid gap-6 ${
              ...
              {currentProducts.map((product) => (
                <Link key={product.id} to={`/categories/computers/${product.id}`} className="group">
