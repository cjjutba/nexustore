...
import { Grid, List, Heart, Star, Dumbbell } from "lucide-react";
...
const Sports = () => {
  ...
  const allProducts = useMemo(() => getProductsByCategory('Sports'), []);
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-muted-foreground">
                Showing {currentProducts.length} of {sortedProducts.length} sports products
              </p>
            ...
            <div className={`grid gap-6 ${
              ...
              {currentProducts.map((product) => (
                <Link key={product.id} to={`/categories/sports/${product.id}`} className="group">
