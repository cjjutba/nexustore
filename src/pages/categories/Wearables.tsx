...
import { Grid, List, Heart, Star, Watch } from "lucide-react";
...
const Wearables = () => {
  ...
  const allProducts = useMemo(() => getProductsByCategory('Wearables'), []);
      ...
      <div className="bg-gradient-surface py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center mb-6">
            <Watch className="w-12 h-12 text-primary mr-4" />
            <h1 className="text-4xl font-bold text-foreground">Wearables</h1>
          </div>
        </div>
      </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-muted-foreground">
                Showing {currentProducts.length} of {sortedProducts.length} wearable products
              </p>
            ...
            <div className={`grid gap-6 ${
              ...
              {currentProducts.map((product) => (
                <Link key={product.id} to={`/categories/wearables/${product.id}`} className="group">
